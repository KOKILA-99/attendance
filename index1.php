...
ROLL NO     :<input type="text" size="55" name="rn"  onkeydown="preventCharInput(event)" onblur="novalidate()">
			<span style="color:red;font-size:16" id="roll"></span><br/><br/>
DEPARTMENT  :<input type="text" size="55" name="department" id="dept"><br/><br/>		
...
PARENTS MOB NUM		:<input type="text" size="55" name="phonenum"  onkeydown="preventCharacInput(event)" onblur="phonenumvalidate()">
			<span style="color:red;font-size:16" id="num"></span><br/><br/>
